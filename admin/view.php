				...
				<tr>
					...
					<td>
						...
						<i class="fa fa-trash fa-2x red-icon"
						 ...
						 <div class="modal fade" id="exampleModal<?php echo $id; ?>" role="dialog">
					...
					<td>
						<img src="<?php echo $photo; ?>" alt="photo de <?php echo $nom_complet; ?>" class="img-fluid" width="150px" height="50px">
					</td>
				</tr>
				<?php } ?>
			</tbody>
