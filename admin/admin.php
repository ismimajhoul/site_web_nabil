...
if (isset($_POST) & !empty($_POST)) {
    ...
    $gender = $_POST['gender'];
    $types = $_POST['types'];
    $photo = $_FILES['photo']['name']; // store the filename instead of the file itself

    // move the uploaded photo to a permanent location on the server
	$target_dir = $_SERVER['DOCUMENT_ROOT'] . '/uploads/'; // directory to store the photo
